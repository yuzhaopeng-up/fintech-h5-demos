...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Theme-Dark-9cf" alt="Dark Theme" />
  <a href="https://yuzhaopeng-up.github.io/fintech-h5-demos/"><img src="https://img.shields.io/badge/Live_Demo-Click_Here-brightgreen" alt="Live Demo" /></a>
</p>
...
<p align="center">
  <img src="./screenshots/preview-gallery.jpg" alt="FinTech H5 Demos Gallery" width="800" />
</p>

| Demo | Description | Screenshot |
|------|-------------|------------|
| **Risk Assessment** | Real-time risk scoring dashboard | ![Risk](./screenshots/risk-assessment.png) |
| **Loan Application** | Digital loan form with smart validation | ![Loan](./screenshots/loan-application.png) |
| **Fraud Alert** | Fraud detection monitoring panel | ![Fraud](./screenshots/fraud-alert.png) |
...
| [regulated-rag](https://github.com/yuzhaopeng-up/regulated-rag) |
| [agent-ops-toolkit](https://github.com/yuzhaopeng-up/agent-ops-toolkit) | Enterprise agent infrastructure patterns |
 Zero-dependency RAG for regulated industries |
